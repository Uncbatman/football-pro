...
if not SUPABASE_URL:
    raise ValueError("ERROR: SUPABASE_URL is not set. Add it to your .env file.")
if not SUPABASE_KEY:
    raise ValueError("ERROR: SUPABASE_SERVICE_ROLE_KEY is not set. Add it to your .env file.")
if not FOOTBALL_DATA_API_KEY:
    raise ValueError("ERROR: FOOTBALL_DATA_API_KEY is not set. Add it to your .env file.")
...
def sync_historical_results():
    ...
    # 3. Process Matches
    success_count = 0
    # Process the most recent 50 matches
    for match in matches[-50:]:
        ...
        if home_id and away_id:
            try:
                ...
                print(f"❌ Error for {home_raw} vs {away_raw}: {e}")
